...
`lib/src/web/README.md`, written alongside the rest of the generated package, has the exact file names, `index.html` snippet, and import path for your specific package — copy it from there rather than from generic docs, since it already has your package's real names substituted in.
